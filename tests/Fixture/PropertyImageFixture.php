 ...
 *
 */
class PropertyImageFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'property_image_ibfk_1' => ['type' => 'foreign', 'columns' => ['prop_id'], 'references' => ['property', 'prop_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
